...
//! Project version number for WeChatSeptet.
FOUNDATION_EXPORT double WeChatSeptetVersionNumber;

//! Project version string for WeChatSeptet.
FOUNDATION_EXPORT const unsigned char WeChatSeptetVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <WeChatSeptet/PublicHeader.h>
